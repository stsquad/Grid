...
#pragma message("include sve_reduce_ref.h using references")
  ...
  inline Grid::ComplexF Reduce<Grid::ComplexF, vecf>::operator()(const vecf &in){
    ...
    typename acle<float>::vt *a_v = (typename acle<float>::vt*)&in.v;
...
/* LD2: tested, working
    ...
    typename acle<float>::vt2 a_v = svld2(pg2, (typename acle<float>::pt*)&in);
...
*/
  ...
  inline Grid::ComplexD Reduce<Grid::ComplexD, vecd>::operator()(const vecd &in){
    ...
    typename acle<double>::vt *a_v = (typename acle<double>::vt*)&in.v;
...
/* LD2: tested, working
    ...
    typename acle<double>::vt2 a_v = svld2(pg2, (typename acle<double>::pt*)&in.v);
...
*/
  ...
  inline Integer Reduce<Integer, veci>::operator()(const veci &in){
    ...
    typename acle<Integer>::vt *a_v = (typename acle<Integer>::vt*)&in.v;
